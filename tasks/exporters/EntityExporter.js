...
var THREE = require('three'),
    geometryExporter = new(require('./GeometryExporter'))(),
    geometry2Exporter = new(require('./Geometry2Exporter'))(),
    bufferGeometryExporter = new(require('./BufferGeometryExporter'))(),
    materialExporter = new(require('./MaterialExporter'))();

var EntityExporter = function () {};
