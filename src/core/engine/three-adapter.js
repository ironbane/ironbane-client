angular.module('engine.three-adapter', [
    ...
    .factory('ThreeAdapter', function (THREE, $components, System, MaterialLoader) {
        'use strict';
        ...
        ThreeAdapter.prototype.addedToWorld = function (world) {
            ...
            world.entityAdded('transform', 'mesh').add(function (entity) {
                ...
                if (meshData !== 'model') {
                    mesh = buildPrimitive(meshData.geometryType);
                }

                if (mesh && meshData.material && meshData.material !== '') {
                    MaterialLoader.load(meshData.material)
